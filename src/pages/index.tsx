      ...
      <main className={pageClass}>
        <div className="splashContainer">
          ...
          <div className="splashText">
            <div className="inner">
              <span className="quote">&quot;Proof that the unofficial option is sometimes the best option&quot;</span>
            ...
            <div className="column">
              <ElementOnScroll>
                <div className="title">
                  ...
                  <h1>Higher framerate</h1>
                </div>
                <span>No longer constrained by 90s console hardware, your experience will now be as silky smooth as your modern GPU and monitor can handle!</span>
              </ElementOnScroll>
            </div>
            <div className="column">
              <ElementOnScroll>
                ...
                <span>Make your own fun! With a plethora of enhancements and cheats available, you&apos;re guaranteed to find a new way to play!</span>
              </ElementOnScroll>
            </div>
            <div className="column">
              <ElementOnScroll>
                ...
                <span>Shuffle what rewards you get from things like chests, skulltulas, and more with the built-in randomizer! Endless replayability! No patching required!</span>
              </ElementOnScroll>
            </div>
          </div>
        ...
        <section className="featureSummary">
          <div className="container fullWidth">
            <div className="column left">
              <ElementOnScroll>
                <div className="text">
                  <h1>A familiar but improved experience</h1>
                  <p>We are careful to put any and all changes to the authentic game behind toggles, so that if desired you can play it in all of its 1998 glory.</p>
                </div>
              </ElementOnScroll>
            </div>
