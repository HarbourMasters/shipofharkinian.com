                ...
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <ul>
                      ...
                      <li>Improvements to the built-in extraction process to handle larger paths and detect MQ vs Vanilla when generating OTRs back to back</li>
                    ...
                    <ul>
                      ...
                      <li>Fix crash on Mac when displaying SoH custom graphics like the DPad or quest selection screen</li>
                      <li>Fix situation where capturing a Poe or buying bottle refills from shops would fill all empty bottles instead of one</li>
                      <li>Properly load custom models on scene transition</li>
                      <li>Fix Keys/Maps/Compasses not being set for the correct dungeon when using Own Dungeon items and Boss Rooms are shuffled</li>
