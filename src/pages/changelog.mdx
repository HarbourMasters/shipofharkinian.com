...
- Choose vanilla/mq when creating a new save file

#### New Enhancements

- Improved debug warp screen
- Walk speed modify buttons
- Mirror shield cosmetic option
- Gauntlets cosmetic option
- Chest size matches contents
- Free cam sensistivity
- Timeless equipment cheat
- Cheat for hookshot everything
- SFX Editor
- Time saver: Ask to equip item
- Glitch line-up tick
- Bombs explode from nut (enhancement)
- Magic arrows equipping enhancements
- Clear flags option in save editor
- Show player state flags in save editor
- Expanded Save Editor for Fishing Minigame
- Switch age and reload link
...
- Support for shuffling both vanilla and MQ dungeons in a single seed (for people who have both roms)
- Randomize starting age
- More readable randomizer save format
- Randomized Entrances
- Randomized ice trap messages
- Randomized ice trap models
- LACS settings for ganons boss key
- Keyrings
- Track keys/heart containers/heart pieces collected
- Skip DoT and rainbow bridge cutscenes
- Chests of agony (stone of agony reveals type of item in chest)
- More flexible heart HUD display
- Shuffle merchants in randomizer
- Implement hint for dungeon type on Map get item messages
- Option to start with a specified number of skulltula tokens
