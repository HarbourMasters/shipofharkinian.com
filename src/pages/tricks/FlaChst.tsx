              ...
              <div className="column">
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <p>Skipping the puzzle in the torch slug and fake doors room in Spirit Temple by running into the fire to open the chest.
                    </p>
                    <video controls width="853" height="480">
                      <source src="./../trickvids/FlaChstSpirit.webm" type="video/webm"/>
                    </video>
                    ...
                    <video controls width="853" height="480">
                      <source src="./../trickvids/FlaChstGTG.webm" type="video/webm"/>
                    </video>
                    <h3>List of Fire Rings that may become relevant on alternate builds or with future Tricks or Shuffles
                    </h3>
                    <p>At the top of Master Quest Spirit Temple, you can push against the fire ring to grab the second mirror in the cave and avoid needing to activate the sun switch. This allows the mirrors to be pushed as Child.
                    </p>
                    <video controls width="853" height="480">
                      <source src="./../trickvids/FlaChstMQSpirit4F.webm" type="video/webm"/>
                    </video>
                  </div>
                </div>
              </div>
