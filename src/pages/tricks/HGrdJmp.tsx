              ...
              <div className="column">
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <p>This trick covers Ground Jumps either with tighter execution requirements, or additional actions on top that are not their own trick. It is recommended to enable the regular Ground Jumps trick with this trick.
                    </p>
                    <p>2 Common varients of this are the Middair Ground Jump, where you use Hover Boots after setting up the Ground Jump to use the Ground jump in a location without a floor, And the ground jump Jump Slash where you use a well timed Jumpslash in the middle of a Ground jump in order to gain even more height and get things like skull tokens that are out of reach.
                    </p>
                    <h2>Relevant Middair Ground Jumps:
                    </h2>
                    ...
                    <h2>Middair Ground Jumps that may become relevant on alternate builds or with future shuffles/tricks:
                    </h2>
                    <p>&quot;Forest Temple MQ Doorframe GS as Child without Boomerang&quot; can be performed with a Middair Ground Jump instead.
                    </p>
                    ...
                    <h2>Relevant Ground Jump JumpSlashes:
                    </h2>
                    <p>The Gold Skulltula Token in Haunted Wasteland can be reached using a Ground Jump JumpSlash as Adult.
                    </p>
                    <p>Adult can use a Ground Jump JumpSlash to skip needing a Hootshot to get MQ Jabu Jabu Invisible Keese room&quot;s Gold Skultulla Token.
                    </p>
                    <p>You can reach the Gold Skulltula Token in Stone umbrella Room using a Ground Jump JumpSlash as Adult.
                    </p>
                    <h2>Ground Jump JumpSlashes that may become relevant on alternate builds or with future shuffles/tricks:
                    </h2>
                    ...
                    <h2>Other relevant uses:
                    </h2>
                    <p>In MQ Dodongo&quot;s cavern, Child can use the bomb flower to set up a Ground Jump to the Lobby Ledge Chest. Due to the Platforming between the flower and the ledge, this must be executed quickly.
                    </p>
                    <h2>Other uses that may become relevant on alternate builds or with future shuffles/tricks:
                    </h2>
