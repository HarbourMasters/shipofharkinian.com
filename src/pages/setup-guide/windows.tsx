              ...
              <div className="column">
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <Image src={image5} style={{maxWidth: '75%', maxHeight: '75%'}} alt={"Windows ROM CRC Error"} />
                    ...
                    <Image src={image4} style={{maxWidth: '75%', maxHeight: '75%'}} alt={"Windows No OTR Files Found"} />
                    ...
                    <Image src={image3} style={{maxWidth: '75%', maxHeight: '75%'}} alt={"Windows No Roms Found"} /><br />
                    ...
                    <Image src={image2} style={{maxWidth: '75%', maxHeight: '75%'}} alt={"Windows Rom Extracted"} /><br />
