              ...
              <div className="column">
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <Image src={image5} style={{width: 'auto', height: '75%', maxHeight: '75%', minWidth: '0%', minHeight: '0%'}} alt={"Windows ROM CRC Error"} />
                    ...
                    <Image src={image4} style={{width: 'auto', height: '75%', maxHeight: '75%', minWidth: '0%', minHeight: '0%'}} alt={"Windows No OTR Files Found"} />
                    ...
                    <Image src={image3} style={{width: 'auto', height: '75%', maxHeight: '75%', minWidth: '0%', minHeight: '0%'}} alt={"Windows No Roms Found"} /><br />
                    ...
                    <Image src={image2} style={{width: 'auto', height: '75%', maxHeight: '75%', minWidth: '0%', minHeight: '0%'}} alt={"Windows Rom Extracted"} /><br />
