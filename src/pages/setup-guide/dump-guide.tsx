                ...
                <div className="textBackground">
                  <div className="textArea">
                    ...
                    <p><ul>
                      ...
                      <li>Ship of Harkinian ( <Link href={"https://github.com/HarbourMasters/Shipwright/releases/latest"}>GitHub</Link> | <Link href={"https://discord.com/invite/harbourmasters"}>Discord</Link> )</li>
                    </ul>
                    </p>
                    <h3>Procedure</h3>
                    <p>
