        ...
        <div className="menuContainer">
          ...
          <section className="menuList">
            <ul>
              ...
              <li><Link href="/setup-guide/">{t('SETUP GUIDE')}</Link></li>
              <li><Link href="/faq/">{t('FAQ')}</Link></li>
              <li><Link href="/changelog/">{t('CHANGELOG')}</Link></li>
              <li><Link href="/randomizer/">{t('RANDOMIZER')}</Link></li>
            </ul>
            <div className="socials">
              <Link href="https://discord.com/invite/shipofharkinian" target="_blank">
              ...
              <Link href="https://github.com/HarbourMasters/Shipwright" target="_blank">
